...
export const HeroSection = () => {
  return (
    <section className="relative overflow-hidden pt-16 pb-4 md:pt-8 md:pb-8">
      ...
      <div className="container relative z-10 py-4 md:py-10 px-4 md:px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <motion.p
            ...
            className="text-center text-base md:text-lg text-muted-foreground max-w-2xl mx-auto mb-5 px-2"
          >
          ...
          <motion.div
            ...
            className="relative max-w-3xl mx-auto mb-5"
          >
          ...
          <motion.div
            ...
            className="grid grid-cols-2 sm:flex sm:flex-wrap justify-center gap-2 sm:gap-3 md:gap-6 mt-8 mb-5"
          >
            {[
          ...
          >
            <span className="text-sm mb-2">⬇️ Veja exatamente o que vem no Kit Jogos de Luz</span>
            <motion.div
              animate={{ y: [0, 8, 0] }}
